...
f, primes, P = setup(1024, 3.2, 60, 80, 50)

# print('-----plaintext-----')
msg1 = np.random.randint(0, 2, 1024).tolist()
print(hex_rep(msg1))
...
print(f'key:{asizeof.asizeof(sk)+asizeof.asizeof(pk)+asizeof.asizeof(swk)/1024}')
print('-----Encryption-----')
c1 = Ctxt(1024, 3.2, primes, P, 40)
...
print('Done {0: .3f}s'.format(cost))
print(f'c1:{asizeof.asizeof(c1)/1024}')

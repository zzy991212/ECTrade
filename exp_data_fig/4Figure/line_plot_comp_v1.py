...
line1 = ax.plot(x_values, ourplan_500k_ms,
                label='SECRETrade 500K', linestyle='-', color=color_sercretrade, linewidth=3, zorder=7)
...
line2 = ax.plot(x_values, ourplan_5m_ms,
                label='SECRETrade 5M', linestyle='-', color=color_sercretrade, linewidth=3, zorder=8)
...
# 保存
plt.savefig(f'v1-transfer_time_comparison_{LorW}.pdf', bbox_inches='tight', dpi=300)
